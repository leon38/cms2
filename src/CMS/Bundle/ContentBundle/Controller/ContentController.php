...
class ContentController extends Controller
{
  ...
  private function createEditForm(Content $entity, $fields, $fieldvalues, $metavalues)
  {
    ...
    $form->add('submit', 'submit', array('label' => 'Update', 'attr' => array('class' => 'btn btn-info btn-fill pull-right')));
  ...
  {
    $contents = $this->getDoctrine()->getRepository('ContentBundle:Content')->findBy(array(), array('language' => 'ASC', 'title' => 'ASC'));
    $categories = $this->getDoctrine()->getRepository('ContentBundle:Category')->getCategoriesLinks();
    return $this->render('ContentBundle:Content:getLinks.html.twig', array('contents' => $contents, 'categories' => $categories));
  }
}
