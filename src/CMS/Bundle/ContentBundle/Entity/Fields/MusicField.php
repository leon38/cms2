...
use CMS\Bundle\ContentBundle\Form\Type\SpotifyType;
...
class MusicField extends Fields
{
    ...
    {
        $this->options['api'] = array('type' => 'choice', 'name' => 'api', 'value' => $this->getParamsValue($this->params, 'api'), 'choices' => array('Deezer' => DeezerType::class, 'Spotify' => SpotifyType::class));
        return $this->options;
    }
}